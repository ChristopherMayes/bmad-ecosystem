...
the two bunching-phase curves agree digit for digit (the sign is Genesis's ``delay
goes backwards'', $\theta \to \theta - \phi$, applied persistently -- and note
Genesis's phase shifter must have FINITE LENGTH to register at all; a zero-length
...
unaveraged energy ledger closes across a chicane sandwich.
