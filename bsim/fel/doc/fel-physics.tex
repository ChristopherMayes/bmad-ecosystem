...
\begin{equation}\label{eq:ledger}
  E_{\mathrm{beam}} + U + U_{\mathrm{esc}} - U_{\mathrm{sp}}, \qquad
...
as in Genesis and MINERVA). Both vanish in steady state. Measured closure:
...
Neither mode carries the $\sim$97\% radiated outside the acceptance; an optional
analytic loss/diffusion term is the named follow-on (FINDINGS 7.27).
