...
deliberately left visible. Refused by name at parse time: missing \code{b\_max} or \code{l\_period}, a
fieldmap \code{field\_calc}, nonzero \code{kx} (unmapped roll-off), and an unset
\code{ds\_step}. Outside the FEL walk the element is a plain periodic wiggler: the
