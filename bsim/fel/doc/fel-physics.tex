...
cross-check. The one physical term the ledger does not balance is spontaneous
emission (the $|\mathrm{src}|^2$ the SVEA deposit adds without debiting a particle,
as in Genesis and MINERVA); the check level sits above it. The physical field of the
