...
\begin{verbatim}
  ...
  integer fel_method             ! off$, averaged$, unaveraged$. Wiggler and undulator only.
...
\begin{example}
  ...
  %fel_method                 ! Integer switch: off$, averaged$, unaveraged$.
...
\end{example}
Note that \vn{%csr_method}, \vn{%space_charge_method} and \vn{%fel_method} are \vn{integer} switch components
