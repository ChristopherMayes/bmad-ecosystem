...
- On the GPU: harmonics, two polarizations, collective effects, migration and the unaveraged mode, each refused by name. A CUDA backend, which the device interface is shaped for.
