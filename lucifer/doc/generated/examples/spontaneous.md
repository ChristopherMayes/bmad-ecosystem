...
([validation](../../validation.md), the spontaneous-emission section). That check
...
Every file below is read from `lucifer/examples/spontaneous/`, which is where the commands above are run.
