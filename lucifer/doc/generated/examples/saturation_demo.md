---
title: "The saturation demo: one practical SASE case, three trackers, one clock"
short_title: "saturation_demo"
---

<!-- Generated by report_examples.py from examples/saturation_demo/. Do not edit. -->

Everything on this page lives in and runs from `lucifer/examples/saturation_demo/`.
...
!
! The undulator segments are Bmad wiggler elements with fel_method = averaged, so
