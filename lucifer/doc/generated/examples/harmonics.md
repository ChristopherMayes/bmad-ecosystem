...
Every file below is read from `lucifer/examples/harmonics/`, which is where the commands above are run.
...
! third harmonic radiates at 1/3 Angstrom. Production defaults: Bmad's own kernel maps
! (fel_tracking unset), ds_step = 3 periods.
