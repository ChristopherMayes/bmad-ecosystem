---
title: "FLASH1 at 13.7 nm: a real machine at its published parameters"
short_title: "flash1"
---
...
Everything on this page lives in and runs from `lucifer/examples/flash1/`.
...
```fortran
&fel_params
  lat_file = "flash1.bmad"
  global%out_root = "flash1"
  slicing%n_slice = 351
...
&fel_beam_init
  ...
  beam_init%bunch_charge = 7.983503e-11
  beam_init%sig_z = 3.819304e-6
  beam_init%sig_pz = 6e-4
  beam_init%a_norm_emit = 1.5e-6
  beam_init%b_norm_emit = 1.5e-6
  shot_noise = T
/

&fel_wavefront_init
  wavefront_init%lambda0 = 1.37e-8

  wavefront_init%seed_power = 0
  wavefront_init%grid_n_pts = 129
  wavefront_init%grid_half_width = 1.0e-3
/
```
...
UND: wiggler, l = 4.5045, l_period = 0.0273, field_calc = planar_model, &
     b_max = 0.47, tracking_method = fel_averaged, ds_step = 0.0819
