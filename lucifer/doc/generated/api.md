...
*Subroutine* `(dev, device_req, beam, ngrid, sample, harm, npol, fp32_iu, timing, dep_mutate, err_flag)`
...
(api-fel-fp32-field-prep)=
### `fel_fp32_field_prep`

*Subroutine* `(fp32, nx, ny)`
...
(api-fel-filter-margin)=
### `fel_filter_margin`

*Function* `(tolerance, width) result (margin)`
