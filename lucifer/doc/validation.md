...
- Rebuilt by setup: slice membership from the partition, the start position from the window's entry face, the wavenumber and phase rate from the lattice, and the wake kernel from the loaded currents.
