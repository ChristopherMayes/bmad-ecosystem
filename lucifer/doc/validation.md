...
| a frame's own bunching against the stats row's, no conversion between them | **4.8e-15** | 2e-12 |
| a frame's per-slice transverse centroid against the stats row's, no conversion between them | **2.7e-20** | 1e-14 |
