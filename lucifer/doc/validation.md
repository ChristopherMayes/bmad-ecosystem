...
| the quiver restored in an averaged frame, against this mode's own orbit: planar / helical / planar tilted | **8e-8** / **9.5e-5** / **1.6e-5** of the quiver | 1e-3 |
...
| a frame's own bunching against the stats row's, the quiver taken back off | 4.4e-4 with it left on | 2e-12 |
